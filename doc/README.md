...
Several platforms were tested to some extent, although **Ubuntu** and **OSX** have been more thoroughly checked out:
...
Apart of the omnipresent **vim**, a couple of *IDE* were used:

### Atom

Basically for **nodejs** and **go** code.
...
**Note:** Two *Vim* plugins, *vim-mode* and *ex-mode*, might be downloaded if your're accustomed to that editor.

**Note:** If you happen to be only interested on generating documentation, don't forget to configure *doc* task at **make-runner** plugin when *build/Makefile* is selected.

### NetBeans

Basically for **java** and **c++** code.
...
**Note:** If you happen to be interested on launching *image* and   *documentation*, don't forget to add *image* and *doc* tasks when *build/Makefile* is selected.
